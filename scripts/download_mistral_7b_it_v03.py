#!/usr/bin/env python
"""Download Mistral-7B-Instruct-v0.3 from ModelScope."""
...
def build_parser() -> argparse.ArgumentParser:
    default_local_dir = Path("/data/goodtaste_workspace/models/Mistral-7B-Instruct-v0.3")

    parser = argparse.ArgumentParser(
        description="Download Mistral-7B-Instruct-v0.3 from ModelScope.",
    )
    parser.add_argument(
        "--model-id",
        default=MODEL_ID,
