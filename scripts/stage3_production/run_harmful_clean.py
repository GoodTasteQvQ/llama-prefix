#!/usr/bin/env python3
"""Validate or run the fixed Paper 1 Stage 3 harmful-clean stage."""
...
from stage3_pipeline.harmful_clean_runner import (  # noqa: E402
    DEFAULT_CONFIG,
    run_harmful_clean,
    validate_only,
)
