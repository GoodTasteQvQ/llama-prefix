#!/usr/bin/env python3
"""Matched-frame two-phase corrected RD for Stage 3 v3.5-rc2.

The caller supplies exactly the two response rows for every pair in one frozen
...
class CorrectionError(ValueError):
    """Raised when an input cannot identify the frozen matched estimand."""
