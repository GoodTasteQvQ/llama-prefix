#!/usr/bin/env python
"""Download Llama 3.1 8B Instruct from ModelScope."""
...
def build_parser() -> argparse.ArgumentParser:
    default_local_dir = Path("/data/goodtaste_workspace/models/Meta-Llama-3.1-8B-Instruct")

    parser = argparse.ArgumentParser(
        description="Download Llama 3.1 8B Instruct from ModelScope.",
    )
    parser.add_argument(
        "--model-id",
        default=MODEL_ID,
