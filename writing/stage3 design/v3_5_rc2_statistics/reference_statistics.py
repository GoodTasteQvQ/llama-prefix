#!/usr/bin/env python3
"""Executable v3.5-rc2 reference for the P1 and raw P2 intervals.

This module intentionally uses only the Python standard library. It is a
protocol reference, not a runner for any formal experiment.
"""
...
class NonEstimable(ValueError):
    """Raised when a frozen non-estimability condition is met."""
...
def evaluate_fixture(data: dict[str, Any]) -> dict[str, Any]:
    return {
        "fixture_schema": "v3.5-rc2-statistical-golden-v1",
...
def evaluate_failure_fixture(base: dict[str, Any], spec: dict[str, Any]) -> dict[str, Any]:
    ...
    return {"fixture_schema": "v3.5-rc2-statistical-failure-v1", "results": results}
