...
F3/E2 已完成，F4/E2R 实现修复和离线测试也已完成。当前只允许 A-recovery 生成受限 Core recovery proposal；F2、B6、C3 不重跑，不启动正式 evaluation。proposal 审查和负责人批准前不得新增 Judge 调用、突破旧 retry 预算或修改旧 F2 结果。
