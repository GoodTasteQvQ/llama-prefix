...
| 新 A-judge-v3 会话 | [Core Judge v3 direct-JSON budget repair](paper1_server_codex_core_judge_protocol_v3_direct_json_budget_repair_prompt_nohup.md) | 已完成；`DIRECT_JSON_BUDGET_CONTRACT_REPAIRED` / `IMPORT_PREFLIGHT_PASS`，R1批准失效 |
